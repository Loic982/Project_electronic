...
humsol=chan0.value   #valeur a échantilloner
soleil=chan2.value   #valeur a echantilloner
pluie =chan1.value   #valeur a echantilloner
...
fenetre_ouvert = False  #boucle afffichage 10 fois
print("Début boucle")
